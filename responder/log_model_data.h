...
public:
    ...
    QString summary() {
        ...
        if (mType == TwampLogString) {
            ...
            str += "[CONTROL] Sent Server-Greeting";
        } else if (mStatus == HandshakeSetupResponse) {
            str += "[CONTROL] Received Setup-Response";
        } else if (mStatus == HandshakeServerStart) {
            str += "[CONTROL] Sent Server-Start";
        } else if (mStatus == HandshakeRequestSession) {
            str += "[CONTROL] Received Request-Session";
        } else if (mStatus == HandshakeAcceptSession) {
            str += "[CONTROL] Sent Accept-Session";
        } else if (mStatus == HandshakeStartSession) {
            str += "[CONTROL] Received Start-Sessions";
        } else if (mStatus == HandshakeStartSessionAck) {
            str += "[CONTROL] Sent Start-Sessions-ACK";
        } else if (mStatus == HandshakeStopSession) {
            str += "[CONTROL] Received Stop-Sessions";
        }
        return str;
    }
    QString timing() {
