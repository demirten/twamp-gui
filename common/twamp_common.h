...
#define TWAMP_CONTROL_PROTOCOL_PACKET_TYPE_REQUEST_SESSION  5
#define TWAMP_CONTROL_PROTOCOL_PACKET_TYPE_START_SESSIONS 2
#define TWAMP_CONTROL_PROTOCOL_PACKET_TYPE_STOP_SESSIONS 3
